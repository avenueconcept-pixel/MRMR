...
$(function () {
  ...
  if (dt_customer_table.length) {
    var dt_customer = dt_customer_table.DataTable({
      ajax: {
        url: '/JobsheetF/OptionItemList?handler=DataList', // Replace with your actual handler path
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              '/JobsheetF/OptionItemEdit/?optionId=' + full['optionId'] +
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $status = full['optionCategoryNameList'];
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['optionName'];
            }
          }),
          type: 'column',
