...
$(function () {
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/BonusJobList?handler=JobsheetData', // Replace with your actual handler path
      ...
      columns: [
        ...
        { data: 'jobType' }, //email //avatar
        { data: 'totalAmount' },
        { data: 'jobStatus' },
        { data: 'bonusMarginAmount' },
        { data: '' }
      ],
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 7,
          render: function (data, type, full, meta) {
            var $columnValue = full['bonusMarginAmount'];
      ...
      
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/JobsheetF/Edit/' + full['jobId'] +'" class="dropdown-item"><i class="ri-edit-line text-heading ri-26px"></i></a>' +
              '<a href="/JobsheetF/Print/' + full['jobId'] +'" target="_blank" class="dropdown-item delete-record">' +
              '<i class="ri-printer-line text-heading ri-26px"></i>' +
              '</a>' +
              '</div>' +
              '</div>'
            );
