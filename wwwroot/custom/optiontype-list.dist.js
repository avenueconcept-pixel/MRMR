...
$(function () {
  ...
  if (dt_customer_table.length) {
    var dt_customer = dt_customer_table.DataTable({
      ajax: {
        url: '/JobsheetF/OptionTypeList?handler=DataList', // Replace with your actual handler path
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              '/JobsheetF/OptionTypeEdit/?typeId=' + full['typeId'] +
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['typeName'];
            }
          }),
          type: 'column',
