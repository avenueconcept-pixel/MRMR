...
$(function () {
  ...
  var dt_order_table = $('.datatables-order-summary'),
    statusObj = {
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/BonusByUser?handler=SummaryData', // Replace with your actual handler path
