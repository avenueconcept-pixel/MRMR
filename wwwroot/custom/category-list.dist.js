...
$(function () {
  ...
  if (dt_customer_table.length) {
    var dt_customer = dt_customer_table.DataTable({
      ajax: {
        url: '/ProductF/CategoryList?handler=DataList', // Replace with your actual handler path
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              '/ProductF/CategoryEdit/?CategoryId=' + full['categoryId'] +
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $status = full['totalProductCount'];
