...
$(function () {
  ...
  var dt_order_table = $('.datatables-order-designer')
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/SummaryByUser?handler=JobsheetData&departmentCode=Designer', // Replace with your actual handler path
  ...
  // Delete Record
  $('.datatables-order-designer tbody').on('click', '.delete-record', function () {
