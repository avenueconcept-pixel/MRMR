...
$(function () {
  ...
  var dt_order_table = $('.datatables-order-account')
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/SummaryByUser?handler=JobsheetData&departmentCode=Account', // Replace with your actual handler path
  ...
  // Delete Record
  $('.datatables-order-account tbody').on('click', '.delete-record', function () {
