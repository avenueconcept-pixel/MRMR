...
$(function () {
  ...
  var dt_customer_table = $('.datatables-customers'),
    select2 = $('.select2'),
    customerView = '/CustomerF/CustomerOverview/' ;
  if (select2.length) {
    var $this = select2;
    select2Focus($this);
  ...
  if (dt_customer_table.length) {
    var dt_customer = dt_customer_table.DataTable({
      ajax: {
        url: '/CustomerF/CustomerListing?handler=CustomerData', // Replace with your actual handler path
      ...
      columns: [
        ...
        { data: 'location' },
        { data: 'totalJobsheetCount' },
        { data: 'totalJobsheetAmount' }
      ],
      columnDefs: [
        {
          // For Responsive
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              '/CustomerF/CustomerOverview/?CustomerId=' + full['customerId'] +
              '"class="text-primary text-decoration fw-medium">' +
              $name +
              '</span></a>' +            
              '</div>' +
              '</div>';
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $name = full['contactPersonName'],
              $email = full['email'],
              $mobile = full['mobileNumber'];
        ...
        },
        {
          ...
          targets: 5,
          render: function (data, type, full, meta) {
            var $status = full['totalJobsheetCount'];
        ...
        },
        {
          ...
          targets: 6,
          render: function (data, type, full, meta) {
            var $spent = full['totalJobsheetAmount'];
