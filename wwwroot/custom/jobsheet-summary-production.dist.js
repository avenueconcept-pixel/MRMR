...
$(function () {
  ...
  var dt_order_table = $('.datatables-order-production')
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/SummaryByUser?handler=JobsheetData&departmentCode=Production', // Replace with your actual handler path
  ...
  // Delete Record
  $('.datatables-order-production tbody').on('click', '.delete-record', function () {
