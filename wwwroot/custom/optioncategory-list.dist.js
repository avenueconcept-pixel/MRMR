...
$(function () {
  ...
  if (dt_customer_table.length) {
    var dt_customer = dt_customer_table.DataTable({
      ajax: {
        url: '/JobsheetF/OptionCategoryList?handler=DataList', // Replace with your actual handler path
      ...
      columns: [
        ...
        { data: '' },
        { data: 'optionCategoryId' },
        { data: 'optionCategoryName' },
        { data: 'seqNo' },
        { data: 'jobTypeName' },
        { data: 'typeName' },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $name = full['optionCategoryName'];
            ...
            var $row_output =
              ...
              '<a href="' +
              '/JobsheetF/OptionCategoryEdit/?optionCategoryId=' + full['optionCategoryId'] +
              '"class="text-primary text-decoration fw-medium"><span class="fw-medium text-truncate">' +
              $name +
              '</span></a>' +            
              '</div>' +
              '</div>';
      ...
      buttons: [
        ...
        {
          text: '<i class="ri-user-add-line ri-20px me-0 me-sm-1 align-baseline"></i><span class="d-none d-sm-inline-block"></span>',
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['optionCategoryName'];
            }
          }),
          type: 'column',
