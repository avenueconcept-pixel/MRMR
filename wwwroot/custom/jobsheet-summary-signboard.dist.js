...
$(function () {
  ...
  var dt_order_table = $('.datatables-order-signboard')
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: {
        url: '/JobsheetF/SummaryByUser?handler=JobsheetData&departmentCode=Signboard', // Replace with your actual handler path
  ...
  // Delete Record
  $('.datatables-order-signboard tbody').on('click', '.delete-record', function () {
